 ...
 *
 * By default surfaces with an alpha mask are set m_Up for blending as with:
 *
 * ```c++
...
/**
 * Set m_Up a surface for directly accessing the pixels.
 *
 ...
 * SDL_MapRGB().
 *
 * RLE acceleration can substantially speed m_Up blitting of images with large
